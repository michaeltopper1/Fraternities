...
kable_paper() %>% 
  pack_rows("Panel A: University-Enacted Moratoriums", 1, 6, hline_after = T, italic = T, bold  =F) %>% 
  pack_rows("Panel B: IFC-Enacted Moratoriums", 7, 12, hline_after = T, italic  = T, latex_gap_space = "0.5cm", bold = F) %>% 
