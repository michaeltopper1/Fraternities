...
es_alc_14 <- ifc::reghdfe(es_14, "alcohol_offense_per25", explanatory_vars_14, fixed_effects, 
                          cluster = "university", weights = es_14$total_enrollment)


es_sex_14 <- ifc::reghdfe(es_14, "sexual_assault_per25", explanatory_vars_14, 
                          fixed_effects, cluster = "university", weights = es_14$total_enrollment)
