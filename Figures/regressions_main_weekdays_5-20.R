...
main_regs_weekdays <- modelsummary(main_regs_w, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within',
                                  ...
                                  title = "Effect of Fraternity Moratoria on Crime (Mon/Tue/Wed/Thur)",
