...
alc_models_restricted <- list("Per 100k Students" = per100_d, "IHS(Alcohol Offense)" = ihs_d,
                   "Per 100k Students"= per100_w,
                   "IHS(Alcohol Offense)" = ihs_w)
alc_ols_restricted <- modelsummary(alc_models_restricted, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within|R2 Ps',
