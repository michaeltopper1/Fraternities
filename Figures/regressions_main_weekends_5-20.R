...
main_regs_weekend <- modelsummary(main_regs_w, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within',
                          ...
                          title = "Effect of Fraternity Moratoria on Crime (Fri/Sat/Sun)",
