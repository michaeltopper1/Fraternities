...
ols_inverse_nocontrol <- felm(inverse_sine_rape ~ treatment*university_enacted + serving_population|
                                university + date | 0 |
                                university, data = ucr_master, cmethod = "reghdfe")

## controls no missing 
ols_inverse_sat <- felm(inverse_sine_rape ~ treatment*university_enacted + 
                      graduation_rate + serving_population + 
...
ols_inverse_all <- felm(inverse_sine_rape ~ treatment*university_enacted + 
               graduation_rate + serving_population + 
              undergrad_proportion_asian + undergrad_proportion_black + undergrad_proportion_hispanic + 
              undergrad_proportion_white + sat_math_75_perc + sat_reading_75_perc +
...
## 
ols_inverse_nosat <- felm(inverse_sine_rape ~ treatment*university_enacted + 
                        graduation_rate + serving_population + 
                        undergrad_proportion_asian + undergrad_proportion_black + undergrad_proportion_hispanic + 
...
ols_inverse_nocontrol_uni <- felm(inverse_sine_rape ~ treatment*university_enacted + serving_population|
                                university + date | 0 |
                                university, data = uni_only, cmethod = "reghdfe")

## no missing 
ols_inverse_sat_uni <- felm(inverse_sine_rape ~ treatment*university_enacted + 
                          graduation_rate + serving_population + 
                          undergrad_proportion_asian + undergrad_proportion_black + undergrad_proportion_hispanic + 
...
ols_inverse_all_uni <- felm(inverse_sine_rape ~ treatment*university_enacted + 
                      graduation_rate + serving_population + 
                      undergrad_proportion_asian + undergrad_proportion_black + undergrad_proportion_hispanic + 
                      undergrad_proportion_white + sat_math_75_perc + sat_reading_75_perc +
                      proportion_firsttime_foreign + proportion_ftenroll|
...
ols_inverse_nosat_uni <- felm(inverse_sine_rape ~ treatment*university_enacted + 
                        graduation_rate + serving_population + 
                        undergrad_proportion_asian + undergrad_proportion_black + undergrad_proportion_hispanic + 
                        undergrad_proportion_white  +
                        proportion_firsttime_foreign + proportion_ftenroll|
