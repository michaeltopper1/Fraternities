...
sex_models <- list("Per 100k Students" = per100_d, "IHS(Sexual Assault Report)" = ihs_d,
                   "Per 100k Students"= per100_w,
                   "IHS(Sexual Assault Report)" = ihs_w)
sex_ols <- modelsummary(sex_models, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within|R2 Ps',
                        ...
                        output = "kableExtra",title = "Effect of fraternity moratoria on reports of sexual assaults (excluding summer)") %>% 
