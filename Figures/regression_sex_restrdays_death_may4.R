...
sex_ols_restricted <- modelsummary(sex_models_restricted, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within',
                                   ...
                                   output = "kableExtra", title = "Effect of fraternity moratoria on reports of sexual assault. Restricting schools to death-trigger only.") %>% 
