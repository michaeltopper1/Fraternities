...
alc_ols <- modelsummary(alc_models_restricted, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within',
                                   ...
                                   output = "kableExtra",title = "Effect of fraternity moratoria on alcohol offenses. June, July, August excluded.") %>% 
