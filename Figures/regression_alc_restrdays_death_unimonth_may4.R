...
alc_models_restricted <- list("OLS - Per 1000 Students" = per1000_d, "Poisson" = pois_d,
                              ...
                              "Poisson" = pois_w)
alc_ols_restricted_death_uni_month <- modelsummary(alc_models_restricted, stars = T, gof_omit = 'DF|Deviance|AIC|BIC|Log|R2 Within|R2 Ps',
  ...
  add_footnote("Poisson regressions are based on counts and not per-1000.") %>% 
