...
\textit{Note:} The main analysis uses data from 37 universities' Daily Crime Logs—each unique in their own respect. All Daily Crime Logs are collected from each university and harmonized using the pattern matching technique outlined in Section 3.
\end{figure}
```
