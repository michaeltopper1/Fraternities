...
Second, to understand the results of the IFC fraction analysis, I plot each university’s undergraduate IFC fraction against its Niche.com Colleges with the Best Greek Life ranking. This ranking, based on survey responses from Niche.com users, ranges from 1-300, and 32 out of the 37 universities in the sample are ranked in the top 300. For the remaining five schools, I assign a ranking between 301-305.

The scatterplot in Figure \ref{scatter_rank_ifc} shows an inverse relationship: as the Greek Life ranking increases, the fraction of undergraduates in an IFC fraternity generally decreases. This likely contributes to the negative point estimates in the previous analysis. However, there also  nine universities that have a top 100 ranking but below-average IFC fractions, and three unranked schools with above-average IFC fractions. While rank orderings fluctuate year-to-year, most schools do not enter and exit the rankings. Instead, rankings change minimally, as top fraternity schools tend to maintain their reputation. This suggests that while there is a correlation between a university's Greek Life ranking and its IFC fraction, the measure is relatively noisy, which may explain why the previous analysis only provided suggestive rather than clear evidence.
