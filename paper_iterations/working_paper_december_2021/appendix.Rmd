...
```{r}
reasons_table %>% 
  add_footnote(list("Description of the triggering event is summarized based on newsarticles or conversations with Fraternity and Sorority Life staff. The date of the triggering event is shown if provided. The classification of each event is based off of the description and aligns with Figure \ref{triggerplot}.")
    ,threeparttable = T) %>% 
  landscape() %>% 
