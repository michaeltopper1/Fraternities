...
In this appendix, I estimate a model that contains no negative weights to acknowledge the potential issues with the difference-in-differences estimator as discussed in Section \ref{section:strategy}.\ref{section:did}. These weights are calculated using the TwoWayFEWeights package [@de_chaisemartin_twowayfeweights_2020]. The estimated model is the following two-way fixed effects (TWFE) specification:
