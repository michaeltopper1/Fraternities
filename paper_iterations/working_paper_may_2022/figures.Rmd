...
gridExtra::grid.arrange(diff_average_offenses, left = textGrob("Average Difference in Moratorium Days and Non-Moratorium Days", 
                                                               rot = 90, gp = gpar(fontsize = 11)), bottom = textGrob("University", gp = gpar(fontsize = 11)))
```
```{=latex}
