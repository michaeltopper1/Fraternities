...
\textit{Note:} The sample period starts in 2014 and ends on the last day of 2019. The lengths of the moratoriums in this graph represent calendar-day lengths, not academic-calendar day lengths. Universities experience between 1 to 3 moratoriums in the sample period.
\end{figure}
\end{landscape}
```
