---
title: "Fraternity Project Update: Full Sample (Document 2!)"
subtitle: ""
author: 
  - Michael Topper
...
* *Event studies are painful and sometimes inconsistent*. How do these look here? Are they passable?
...
```{r}
source("Figures/month_by_year_crimes.R")
```
...
```{r distribution}
source("Figures/closure_distribution.R")
```
...
```{r}
source("Figures/event_study_may4.R")
```
...
alcohol_es_pois_uni_month
alcohol_es_ols_uni_month
alcohol_es_pois
alcohol_es_ols
```
...
sex_es_pois_uni_month
sex_es_ols_uni_month
sex_es_pois
sex_es_ols
```

```{r alc_ols}
source("Figures/regression_alc_may4.R")
```
...
```{r alc_restrict_ols}
source("Figures/regression_alc_restrdays_may4.R")
```
...
```{r sex_ols}
source("Figures/regression_sex_may4.R")
```
...
```{r sex_restrict_ols}
source("Figures/regression_sex_restrdays_may4.R")
```
