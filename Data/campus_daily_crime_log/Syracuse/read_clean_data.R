...
## 2014
path_2014 <- "Data/campus_daily_crime_log/Syracuse/2014 DCL.xlsx"
...
syr_16 <- pdf_text("Data/campus_daily_crime_log/Syracuse/2016 DCL.pdf")

syr_16 %>% str_split('\n') %>% unlist() %>% str_trim() %>% str_to_lower() ->syr_16
...
syra_incident <- syr_16[incidents] %>% 
  ...
  extract(other, c("incident", "date_occurred", "time_occurred", "date_reported", "time_reported"),
          "(.{1,})\\s{1,}(\\d{2}/\\d{1,2}/\\d{4}).{1,}(\\d{1,2}:\\d{1,2}:\\d{1,2}).{1,}(\\d{2}/\\d{1,2}/\\d{4}).{0,}(\\d{1,2}:\\d{1,2}:\\d{1,2})")  %>% 
...
syra_17 <- pdf_text("Data/campus_daily_crime_log/Syracuse/2017 DCL.pdf")
...
path_2017_2 <- "Data/campus_daily_crime_log/Syracuse/2017 DCL_2.xlsx"
...
## cleaning 2018
syra_18 <- pdf_text("Data/campus_daily_crime_log/Syracuse/2018 DCL.pdf")
...
path_2019 <- "Data/campus_daily_crime_log/Syracuse/DCL 2019.xlsx"
...
write_csv(syracuse, file = "Data/campus_daily_crime_log/Cleaned_schools/syracuse.csv")
