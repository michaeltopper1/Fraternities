...
path <- "Data/campus_daily_crime_log/Louisiana State/2015crimereport.pdf"
...
crime_2015 <- bind_cols(cases, incidents)

write_csv(crime_2015, file = "Data/campus_daily_crime_log/Louisiana State/2015.csv")
