#############################################################################
##  This gets in all except the last page of the 2015 data from Louisiana  ##
#############################################################################
...
path <- "/Users/michaeltopper/Desktop/Fraternities and Sexual Assault/Data/campus_daily_crime_log/Louisiana State/2015crimereport.pdf"
...
for (i in 1:iterations){
  ...
  if (i == 1) {
    ...
    first_columns <-  first_columns %>% 
      ...
      separate(col = date_report, into = c("date_report","date_incident"), sep = ", 2015", remove = T) %>% 
...
crime_2015 <- crimes
save(crime_2015, file = "/Users/michaeltopper/Desktop/Fraternities and Sexual Assault/Data/campus_daily_crime_log/Louisiana State/2015.rda")
