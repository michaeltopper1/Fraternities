...
figure_11 <- gridExtra::grid.arrange(game_moratorium_plot, left = textGrob("Coefficient Estimate and 95% Confidence Interval",
                                                              rot = 90, gp = gpar(fontsize = 10)), bottom = textGrob("",gp = gpar(fontsize = 10)))      
ggsave(filename =  "figures/michael-topper-figure-11.pdf",
       plot  = figure_11,
